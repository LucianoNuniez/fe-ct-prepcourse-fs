...
function empiezaConNueve(num) {
   ...
   // Tu código:
   var stringNumero = num.toString();
   return stringNumero.startsWith('9');
}
...
function breakStatement(num) {
   ...
   //Iteramos el bucle y sumamos el numero en 2
   for (let i = 0; i < 10; i++) {
      num += 2;

   //Preguntamos si la iteracion es igual a la suma
   if (num === i) {
         interrumpido = true;
         break;
      }
